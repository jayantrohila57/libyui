/** biome-ignore-all lint/performance/noImgElement: Will not use that component */
...
import { CodeCollapsibleWrapper } from "@/module/common/code-collapsible-wrapper";
import { ComponentPreview } from "@/module/common/component-preview";
import { ComponentSource } from "@/module/common/components-source";
import { onBlockFeedbackAction } from "@/module/github/github";
import { CodeBlockCommand } from "../../module/common/code-block-command";
import { CodeTabs } from "../../module/common/code-tabs";
import { CopyButton } from "../../module/common/copy-button";
import { getIconForLanguageExtension } from "../common/icons";
