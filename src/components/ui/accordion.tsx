...
function Accordion({
  ...
  return (
    <AccordionPrimitive.Root
      data-slot="accordion"
      className={cn("flex border rounded-md w-full flex-col", className)}
      {...props}
    />
  );
}
...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn("not-last:border-b px-4", className)}
      {...props}
    />
  );
}
...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "py-0 [&_a]:hover:text-foreground h-(--radix-accordion-content-height) [&_a]:underline [&_a]:underline-offset-3 [&_p:not(:last-child)]:mb-4",
          className,
        )}
      >
        {children}
