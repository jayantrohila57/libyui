---
title: Mode Toggle
description: Light, dark, and system theme switcher built with next-themes, Radix Dropdown, and Tooltip.
icon: LayoutGrid
---
...
The Mode Toggle is a composite component that lets users switch between **light**, **dark**, and **system** themes. It combines a Radix UI `DropdownMenu`, a `Tooltip`, and the LibyUI `Button` — all animated with CSS transitions.
