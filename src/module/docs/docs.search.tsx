...
import { copyToClipboardWithMeta } from "../common/copy-button";
import type { docsSource } from "./docs.options";
  ...
  const handlePageHighlight = React.useCallback(
    (isComponent: boolean, item: { url: string; name?: React.ReactNode }) => {
      if (isComponent) {
        ...
        setCopyPayload(`${packageManager} dlx shadcn@latest add ${item.url}`);
      }
    },
    [packageManager],
  );
