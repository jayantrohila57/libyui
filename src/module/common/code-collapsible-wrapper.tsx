...
export function CodeCollapsibleWrapper({
  ...
  return (
    ...
    >
      ...
      <CollapsibleContent className="relative mt-6 overflow-hidden data-[state=closed]:max-h-64 data-[state=closed]:[content-visibility:auto] [&>figure]:mt-0 [&>figure]:md:mx-0!">
        {children}
      </CollapsibleContent>
